function App() {
  return (
    <div className='max-w-360 w-full my-0 mx-auto min-h-full flex flex-col relative border-l border-r border-[#e2e5ec]'>
      ...
      <div className='border-t border-[#e2e5ec] absolute top-123 h-px w-full z-[-1]'></div>
      <div className='flex text-center gap-20 max-[1250px]:gap-5 mt-36 max-[1250px]:mt-24 '>
        ...
        <h1 className='font-bold text-[56px] max-[1250px]:text-[30px]'>
          Исторические <br /> даты
        </h1>
      </div>
      <div className='w-134 h-134 flex justify-center items-center max-[1250px]:w-100 max-[1250px]:h-100 mx-auto -mt-22.5 max-[1250px]:mt-25'>
        <div className='border w-full h-full rounded-full'></div>
      </div>
              ...
              <div className='w-auto mr-20 block h-full'>
                <div className='flex flex-col gap-3.75 cursor-move w-100 pb-25 min-h-75 '>
                  ...
                  <p className='text-[20px] leading-7.5 text-[#42567a]'>
                    Премьер-министром Норвегии стала Гру Харлем Брунтланн
                  </p>
                </div>
              </div>
              <div className='w-auto mr-20 block h-full'>
