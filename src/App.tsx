...
const timelineTopics: TimelineTopic[] = [
  {
    ...
    toYear: '1986',
    news: [
      { year: '1981', text: 'В Греции отменили монархические ограничения и усилили парламентскую модель.' },
      { year: '1982', text: 'Начался новый этап переговоров по сокращению вооружений в Европе.' },
      { year: '1983', text: 'Запущена крупная программа цифрового архивирования исторических документов.' },
      { year: '1984', text: 'Расширены международные соглашения о сохранении культурного наследия.' },
      { year: '1985', text: 'Появились новые исследовательские центры по современной истории XX века.' },
      { year: '1986', text: 'В ряде стран обновили национальные исторические реестры и цифровые каталоги.' },
    ],
  },
  {
    id: 2,
    ...
    toYear: '1995',
    news: [
      { year: '1987', text: 'Фестивальное кино получило сильный импульс благодаря независимым студиям.' },
      { year: '1989', text: 'Новые стандарты звука в прокате повысили качество кинопоказов.' },
      { year: '1991', text: 'Компьютерная графика стала заметной частью массовых блокбастеров.' },
      { year: '1993', text: 'Цифровой монтаж ускорил продакшен и удешевил постобработку.' },
      { year: '1994', text: 'Авторское кино усилило позиции на международных фестивалях.' },
      { year: '1995', text: 'Киноиндустрия перешла к гибридной модели с цифровыми эффектами и пленкой.' },
    ],
  },
  {
    id: 3,
    ...
    toYear: '2006',
    news: [
      { year: '1996', text: 'Литературные премии активнее поддержали региональных авторов.' },
      { year: '1998', text: 'Издательства начали масштабные серии переводной современной прозы.' },
      { year: '2000', text: 'Электронные библиотеки расширили доступ к научной и художественной литературе.' },
      { year: '2002', text: 'Новые форматы короткой прозы стали популярны в журналах и онлайн.' },
      { year: '2004', text: 'Нон-фикшн занял значимую долю книжного рынка.' },
      { year: '2006', text: 'Крупные издательские дома запустили цифровые каталоги и подписки.' },
    ],
  },
  {
    id: 4,
    ...
    toYear: '2018',
    news: [
      { year: '2007', text: 'Экспериментальные сцены начали активные гастрольные программы.' },
      { year: '2009', text: 'Театры внедрили цифровые системы света и сценографии.' },
      { year: '2011', text: 'Документальный театр усилил присутствие в репертуаре крупных площадок.' },
      { year: '2013', text: 'Появились гибридные постановки на стыке драмы, видеоарта и музыки.' },
      { year: '2016', text: 'Молодые режиссеры сформировали новые школы сценического языка.' },
      { year: '2018', text: 'Онлайн-трансляции спектаклей расширили международную аудиторию.' },
    ],
  },
  {
    id: 5,
    ...
    toYear: '2028',
    news: [
      { year: '2019', text: 'Расширены телемедицинские сервисы для удаленных регионов.' },
      { year: '2020', text: 'Быстрое обновление клинических протоколов повысило скорость диагностики.' },
      { year: '2021', text: 'Персонализированная терапия получила новые стандарты применения.' },
      { year: '2023', text: 'ИИ-системы начали помогать врачам в анализе диагностических снимков.' },
      { year: '2025', text: 'Роботизированные хирургические комплексы вошли в рутинную практику клиник.' },
      { year: '2028', text: 'Профилактическая медицина стала центральным направлением национальных программ.' },
    ],
  },
  {
    id: 6,
    ...
    toYear: '2042',
    news: [
      { year: '2029', text: 'Квантовые вычисления перешли от лабораторных тестов к пилотным задачам.' },
      { year: '2031', text: 'Новые материалы с адаптивной структурой вышли на промышленный уровень.' },
      { year: '2034', text: 'Международные орбитальные проекты получили долгосрочные научные программы.' },
      { year: '2037', text: 'Энергетические технологии нового поколения снизили потери в сетях.' },
      { year: '2040', text: 'Биоинженерия усилила позиции в восстановительной медицине и фарме.' },
      { year: '2042', text: 'Научные центры внедрили унифицированные платформы открытых исследований.' },
    ],
  },
];
        ...
        <div className='news-slider-shell px-20 max-[1250px]:px-7'>
          ...
          >
            {activeNews.map((news, index) => (
              <article key={`${activeTopic.id}-${news.year}-${index}`} data-news-card className='news-card'>
